            ...
            <div class="card bg-dark" id="table-listagem">
                ...
                <div class="card-body">
                    ...
                    <a href="../Index/index_cursos.php?id=<?php echo $value->id; ?>" style="margin-right:10px;">
                        <button type="button" class="neon-bt"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" style="margin-left:43%;" viewBox="0 0 16 16">
